...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Violation.trigger_content_type'
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Violation.trigger_content_type'
        db.delete_column('dynamic_validation_violation', 'trigger_content_type_id')

        # Deleting field 'Violation.trigger_model_id'
        db.delete_column('dynamic_validation_violation', 'trigger_model_id')
