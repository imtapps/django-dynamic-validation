...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Violation.message'
        db.alter_column('dynamic_validation_violation', 'message', self.gf('django.db.models.fields.CharField')(max_length=300))


    def backwards(self, orm):
        
        # Changing field 'Violation.message'
        db.alter_column('dynamic_validation_violation', 'message', self.gf('django.db.models.fields.CharField')(max_length=100))
