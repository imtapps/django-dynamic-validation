...
class AdminRuleFormTests(unittest.TestCase):
    ...
    def test_should_be_a_model_form_for_rule_model_and_limit_fields(self):
        ...
        self.assertEqual(('name', 'key', 'related_object_id', 'content_type'), admin_forms.RuleForm._meta.fields)
    ...
    @mock.patch('dynamic_validation.admin_forms.RuleForm._get_dynamic_data_for_instance')
